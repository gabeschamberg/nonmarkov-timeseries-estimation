...
The **notebooks** directory contains iPython notebooks that are used to show how the solutions can be used. These notebooks were used to generate the figures in section IV of the paper.